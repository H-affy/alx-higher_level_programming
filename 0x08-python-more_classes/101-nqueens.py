...
determine all possiblr solution to placing N.
...
where 'r' and 'c' represent row and column, respectively, where a queen
...
def board_deepcopy(board):
    """Return a deep copy pof a chess board."""
...
def xout(board, row, col):
    ...
    row(int): The row were queen was last played.
